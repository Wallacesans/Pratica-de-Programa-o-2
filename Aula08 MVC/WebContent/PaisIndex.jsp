	        ...
	        <form action="ManterPais.do" method="post">
	            ...
	            <div class="row">
	                <div class="form-group col-md-6">
	                    ...
	                    <input type="number" class="form-control" name="populacao" id="populacao" maxlength="20" placeholder="Quantidade de População">
	                </div>
	
	                <div class="form-group col-md-6">
	                    <label for="area">Area</label>
	                    <input type="number" class="form-control" name="area" id="area" maxlength="60" placeholder="Area em metros quadrados">
	                </div>
	            </div>
	            <hr />
